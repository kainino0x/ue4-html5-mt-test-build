...
EPIC_MONO=""
if [ -f "/usr/local/google/home/kainino/src/UnrealEngine-HTML5-MT/Engine/Build/BatchFiles/Mac/SetupMono.sh" ]; then
    pushd "/usr/local/google/home/kainino/src/UnrealEngine-HTML5-MT/Engine/Build/BatchFiles/Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'/usr/local/google/home/kainino/src/UnrealEngine-HTML5-MT/Engine/Build/BatchFiles/Mac/SetupMono.sh';
fi
